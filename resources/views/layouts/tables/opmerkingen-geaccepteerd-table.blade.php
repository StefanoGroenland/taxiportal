                 ...
                 <tr data-href="/opmerkingwijzigen/{{$comment->id}}">
                     ...
                     <td>{{$comment->created_at->format('d-m-Y H:i')}}</td>
                         <td width="12%" class="text-right">
                             ...
                             <a class="btn btn-sm yellow-lemon popovers" data-container="body" data-trigger="hover" data-placement="top" data-content="Opmerking afkeuren" href="/toggleComment/{{$comment->id}}/1"><i class="fa fa-remove"></i></a>
