                                        	...
                                        	<div class="row">
                                				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="form-control no-border-radius" name="email" placeholder="">
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group has-info">
                                                        <label for="form_control_1">Telefoonnummer</label>
                                                        <input type="text" class="form-control no-border-radius" required="true" maxlength="10" name="telefoonnummer">
                                                    </div>
                                                </div>
                                           </div>
                                            <div class="row">
                                				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                					<div class="form-group has-info">
                                                		...
                                                		<input type="password" class="form-control no-border-radius" id="form_control_1" placeholder="">
                                           ...
                                           <div class="row">
                                				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                					<div class="form-group has-info">
                                                		...
                                                		<input type="text" class="form-control no-border-radius" id="form_control_1" placeholder="">
