                                        ...
                                        <div class="row">
                                           ...
                                           <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 center-block text-center">
                                                    <div class="fileinput fileinput-new " data-provides="fileinput">
                                                       ...
                                                       <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12 margin-top-40">
                                                           <div class="form-group form-md-line-input">
                                                               <div class="input-icon">
                                                       ...
                                                       <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 margin-top-40">
                                                           <div class="form-group form-md-line-input ">
                                                               <div class="input-icon">
