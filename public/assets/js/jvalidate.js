		...
		function addErrorMessage(elem, type, valid, args) {
			...
			if (!valid) {
				...
				if(settings.errorMessage) {
					...
					if (!elem.parent().siblings('span.jvalidate-error-message').length > 0) {
						...
						errorElem.appendTo(elem.parent().parent());
				...
				elem.parent().siblings('span.jvalidate-error-message').remove();
